...
public class Helpers {
    ...
    public static Hand getSuitedHand(String cardValues) {
        Map<String, Card.CardValue> map = getCardValueMap();
        Map<String, Card.CardSuit> suitMap = geCardSuitMap();
    ...
    public static Card.CardSuit getAvailableSuitFor(Card.CardValue cardValue, Hand hand) {
        if (hand.isEmpty()) {
    ...
    private static Map<String, Card.CardSuit> geCardSuitMap() {
        return Map.of(
                "s", Card.CardSuit.S,
                "h", Card.CardSuit.H,
                "d", Card.CardSuit.D,
